...
- 🤖 [AI agent skill](skills/react-native-video) — use react-native-video correctly with AI coding agents (Claude Code, Cursor, Codex); install with `npx skills add TheWidlarzGroup/react-native-video`
