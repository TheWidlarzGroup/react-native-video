...
@public
  ...
  BOOL slow_start_;
  double slow_start_percentage_;
  double slow_start_rad_;
  double slow_start_end_rad_;
  BOOL init__;
}
...
__attribute__((unused)) static double get_trimmed_video_width(OvalCalculator *self);

__attribute__((unused)) static double get_trimmed_video_height(OvalCalculator *self);

__attribute__((unused)) static void asd_check_view_size_changeWithDouble_withDouble_withDouble_withDouble_(OvalCalculator *self, double view_width, double view_height, double video_width, double video_height);
...
- (instancetype)init {
  self->landscape_offset_percentage_ = 0.0f;
  self->trim_percentage_ = 0;
  self->trim_videoWidth_ = 3;
  self->trim_videoHeight_ = 4;
  ...
  self->slow_start_ = true;
  self->slow_start_percentage_ = 0.50;
  self->slow_start_rad_ = 16.6 * M_PI / 180.0;
  self->slow_start_end_rad_ = 55.0 * M_PI / 180.0;
  self->init__ = false;
  return self;
}

- (void)set_initWithBOOL:(BOOL)init_ {
  self->init__ = init_;
}
...
- (void)set_video_sizeWithDouble:(double)video_width
  ...
  if (trim_videoWidth_ != 0 && trim_videoHeight_ != 0) [self set_trim_sizeWithDouble:video_width withDouble:video_height];
}
...
- (void)set_reduce_zoom_factorWithBOOL:(BOOL)flag {
  reduceZoomFactor_ = flag;
}

- (void)set_avoid_scale_drop_landscapeWithBOOL:(BOOL)flag {
...
- (double)get_trimmed_video_width {
  return get_trimmed_video_width(self);
}

- (double)get_trimmed_video_height {
  return get_trimmed_video_height(self);
}
...
- (double)get_scale_raw_WithDouble:(double)rad {
  ...
  if (trim_percentage_ != 0) {
    video_width = get_trimmed_video_width(self);
    video_height = get_trimmed_video_height(self);
  }
  if (avoidScaleDropLandscape_) asd_check_view_size_changeWithDouble_withDouble_withDouble_withDouble_(self, view_width_, view_height_, video_width, video_height);
...
- (void)asd_check_view_size_changeWithDouble:(double)view_width
                                  ...
                                  withDouble:(double)video_width
                                  withDouble:(double)video_height {
  asd_check_view_size_changeWithDouble_withDouble_withDouble_withDouble_(self, view_width, view_height, video_width, video_height);
}
...
double get_trimmed_video_width(OvalCalculator *self) {
...
double get_trimmed_video_height(OvalCalculator *self) {
...
void asd_check_view_size_changeWithDouble_withDouble_withDouble_withDouble_(OvalCalculator *self, double view_width, double view_height, double video_width, double video_height) {
