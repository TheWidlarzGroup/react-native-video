...
<<<<<<<< HEAD:android/src/oldarch/java/com/brentvatne/exoplayer/VideoEventEmitter.java
...
========
    void load(double duration, double currentPosition, int videoWidth, int videoHeight,
              WritableArray audioTracks, WritableArray textTracks, WritableArray videoTracks, String trackId) {
>>>>>>>> upstream/master:android/src/main/java/com/brentvatne/common/react/VideoEventEmitter.java
