...
namespace margelo::nitro::video::bridge::swift {
  ...
  std::shared_ptr<margelo::nitro::video::HybridVideoPlayerSourceSpec> create_std__shared_ptr_margelo__nitro__video__HybridVideoPlayerSourceSpec_(void* _Nonnull swiftUnsafePointer) {
    NitroVideo::HybridVideoPlayerSourceSpec_cxx swiftPart = NitroVideo::HybridVideoPlayerSourceSpec_cxx::fromUnsafe(swiftUnsafePointer);
  ...
  #endif
    NitroVideo::HybridVideoPlayerSourceSpec_cxx swiftPart = swiftWrapper->getSwiftPart();
  ...
  std::shared_ptr<margelo::nitro::video::HybridVideoPlayerFactorySpec> create_std__shared_ptr_margelo__nitro__video__HybridVideoPlayerFactorySpec_(void* _Nonnull swiftUnsafePointer) {
    NitroVideo::HybridVideoPlayerFactorySpec_cxx swiftPart = NitroVideo::HybridVideoPlayerFactorySpec_cxx::fromUnsafe(swiftUnsafePointer);
  ...
  #endif
    NitroVideo::HybridVideoPlayerFactorySpec_cxx swiftPart = swiftWrapper->getSwiftPart();
    return swiftPart.toUnsafe();
  }
  ...
  Func_void_VideoInformation create_Func_void_VideoInformation(void* _Nonnull swiftClosureWrapper) {
    auto swiftClosure = NitroVideo::Func_void_VideoInformation::fromUnsafe(swiftClosureWrapper);
  ...
  std::shared_ptr<margelo::nitro::video::HybridVideoPlayerSourceFactorySpec> create_std__shared_ptr_margelo__nitro__video__HybridVideoPlayerSourceFactorySpec_(void* _Nonnull swiftUnsafePointer) {
    NitroVideo::HybridVideoPlayerSourceFactorySpec_cxx swiftPart = NitroVideo::HybridVideoPlayerSourceFactorySpec_cxx::fromUnsafe(swiftUnsafePointer);
  ...
  #endif
    NitroVideo::HybridVideoPlayerSourceFactorySpec_cxx swiftPart = swiftWrapper->getSwiftPart();
    return swiftPart.toUnsafe();
  }
  ...
  std::shared_ptr<margelo::nitro::video::HybridVideoViewViewManagerSpec> create_std__shared_ptr_margelo__nitro__video__HybridVideoViewViewManagerSpec_(void* _Nonnull swiftUnsafePointer) {
    NitroVideo::HybridVideoViewViewManagerSpec_cxx swiftPart = NitroVideo::HybridVideoViewViewManagerSpec_cxx::fromUnsafe(swiftUnsafePointer);
  ...
  #endif
    NitroVideo::HybridVideoViewViewManagerSpec_cxx swiftPart = swiftWrapper->getSwiftPart();
    return swiftPart.toUnsafe();
  }
  ...
  std::shared_ptr<margelo::nitro::video::HybridVideoViewViewManagerFactorySpec> create_std__shared_ptr_margelo__nitro__video__HybridVideoViewViewManagerFactorySpec_(void* _Nonnull swiftUnsafePointer) {
    NitroVideo::HybridVideoViewViewManagerFactorySpec_cxx swiftPart = NitroVideo::HybridVideoViewViewManagerFactorySpec_cxx::fromUnsafe(swiftUnsafePointer);
  ...
  #endif
    NitroVideo::HybridVideoViewViewManagerFactorySpec_cxx swiftPart = swiftWrapper->getSwiftPart();
    return swiftPart.toUnsafe();
  }
