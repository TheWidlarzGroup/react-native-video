...
namespace margelo::nitro::video {
  ...
  void JHybridVideoPlayerSpec::setSource(const std::shared_ptr<margelo::nitro::video::HybridVideoPlayerSourceSpec>& source) {
    static const auto method = _javaPart->getClass()->getMethod<void(jni::alias_ref<JHybridVideoPlayerSourceSpec::javaobject> /* source */)>("setSource");
    method(_javaPart, std::dynamic_pointer_cast<JHybridVideoPlayerSourceSpec>(source)->getJavaPart());
  }
