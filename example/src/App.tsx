...
import { disable, enable, isEnabled } from "@twg/react-native-video-drm";
...
const VideoDemo = () => {
  ...
  const player = useVideoPlayer(
    {
      uri: "https://d2e67eijd6imrw.cloudfront.net/559c7a7e-960d-4cd8-9dba-bc4e59890177/assets/47cfca69-91b5-4311-bf6c-b9b1f297ed9b/videokit-720p-dash-hls-drm/hls/index.m3u8",
      // externalSubtitles: [
      //   {
        ...
        getLicense: async ({ spc, keyUrl }) => {
          ...
          try {
            const response = await fetch(
              `${fixedLicenseUrl}&userToken=${userToken}`,
              {
                method: "POST",
                headers: {
