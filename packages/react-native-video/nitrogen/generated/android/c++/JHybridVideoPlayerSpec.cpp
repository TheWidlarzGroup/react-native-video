...
namespace margelo::nitro::video {
  ...
  bool JHybridVideoPlayerSpec::getDisableAudioSessionManagement() {
    static const auto method = javaClassStatic()->getMethod<jboolean()>("getDisableAudioSessionManagement");
    auto __result = method(_javaPart);
    return static_cast<bool>(__result);
  }
  void JHybridVideoPlayerSpec::setDisableAudioSessionManagement(bool disableAudioSessionManagement) {
    static const auto method = javaClassStatic()->getMethod<void(jboolean /* disableAudioSessionManagement */)>("setDisableAudioSessionManagement");
