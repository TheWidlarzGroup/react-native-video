...
/**
 * Represents the JavaScript callback `(texts: array) => void`.
...
fun interface Func_void_std__vector_std__string_: (Array<String>) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(texts: Array<String>): Unit
}
...
class Func_void_std__vector_std__string__cxx: Func_void_std__vector_std__string_ {
  ...
  @FastNative
  private external fun invoke_cxx(texts: Array<String>): Unit
}
