...
:::tip Recommendation
We recommend using the [`useVideoPlayer`](./use-video-player.md) hook instead of the `VideoPlayer` class directly, as it automatically manages the player lifecycle for you.
:::
