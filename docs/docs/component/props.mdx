...
> **Note:** You need to enable IMA SDK in the Gradle or Podfile – see [Enable Client-Side Ads Insertion](/docs/installation).
...
See [Useful Side Projects](/docs/projects).
...
To set up DRM, follow [this guide](/docs/component/drm).
...
Note: You need to enable IMA SDK in the Gradle or Pod file - [enable client-side ads insertion](/docs/installation).
