...
Sets the ad configuration. Supports both Client-Side Ad Insertion (CSAI) and Dynamic Ad Insertion (DAI) through the unified `type` field.
...
| `fallbackUri`     | string | Optional  | Fallback stream URI. If the DAI stream fails to load, the player will automatically fall back to this URI.                                                                                                                |
| `adLanguage`      | string | Optional  | Language code for the IMA SDK (e.g., `'en'`, `'fr'`)                                                                                                                                                                      |
