...
| request  | { [key: `string-string`]: string \| number }  | Custom key-value pairs for the request object      |
| session  | { [key: `string-string`]: string \| number }  | Custom key-value pairs for the session object      |
| object   | { [key: `string-string`]: string \| number }  | Custom key-value pairs for the object metadata     |
| status   | { [key: `string-string`]: string \| number }  | Custom key-value pairs for the status information  |
