...
<<<<<<< HEAD:docs/pages/component/props.mdx
...
paddingLeft | Adjust the left padding of the subtitles. Default: 0| Android
paddingRight | Adjust the right padding of the subtitles. Default: 0| Android
showSubtitles | Toggle the visibility of subtitles. Default: true| Android

>>>>>>> 1ce9dce (chore: update documentation):docs/pages/component/props.md

Example:

```javascript
subtitleStyle={{ paddingBottom: 50, fontSize: 20, showSubtitles: false }}
```
