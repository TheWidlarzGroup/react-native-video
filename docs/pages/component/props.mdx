...
| showSubtitleButton                  | boolean | The default value is `true`, allowing you to show or hide the subtitle button. If the video does not have subtitles, we don't show this button. |
| showSettingButton                   | boolean | The default value is `true`, allowing you to show or hide the setting button.                                                                   |
