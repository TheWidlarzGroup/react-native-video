...
In some cases you'll need DRM-protected video content to be available offline. We've built the [Offline Video SDK](https://www.thewidlarzgroup.com/offline-video-sdk/?utm_source=rnv&utm_medium=docs&utm_campaign=drm&utm_id=offline-video-sdk-link) that allows for downloading, storing and managing HLS/DASH streams with and without DRM. It covers the case cases that you'll painfully discover months or years from now. To learn more please check out [Offline Video SDK](https://www.thewidlarzgroup.com/offline-video-sdk/?utm_source=rnv&utm_medium=docs&utm_campaign=drm&utm_id=offline-video-sdk-link). Prerequisite: use v6 or v7. If you're still on v5 or lower contact us.
