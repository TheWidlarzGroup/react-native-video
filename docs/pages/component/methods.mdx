...
- **idle** (Android only): The player is idle, meaning it holds only limited resources. The media is not yet prepared, and the player must be prepared before it can play the media.
